...
const I18N = {
  es: {
    ...
    no_visits_registered: "Sin visitas registradas",
    ...
    multi_photo_desc_1: "Con",
    multi_photo_desc_2: "fotos se generan",
    multi_photo_desc_3: "clips de transicion (~",
    multi_photo_desc_4: "seg total).",
  ...
  en: {
    ...
    multi_photo_desc_1: "With",
    multi_photo_desc_2: "photos,",
    multi_photo_desc_3: "transition clips are generated (~",
    multi_photo_desc_4: "sec total).",
